...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	function getDynamicConfiguration(){
		...
		$conf['filemanager']['show-hidden'] = 'yes';
		$conf['filemanager']['start-location'] = '/workspace';
		$conf['members']['cookie-prefix'] = 'sym-members';
		$conf['members']['member_section'] = '40';
...
Symphony Team';
		$conf['members']['email_address_field_id'] = '123';
		$conf['members']['timezone_offset_field_id'] = '205';
		$conf['forum']['discussion-section'] = '38';
		$conf['forum']['comment-section'] = '39';
		$conf['forum']['member-link-field'] = '142';
		$conf['forum']['comment-member-link-field'] = '141';
		$conf['forum']['pinned-field'] = '130';
		$conf['forum']['locked-field'] = '131';
		$conf['forum']['comment-field'] = '117';
